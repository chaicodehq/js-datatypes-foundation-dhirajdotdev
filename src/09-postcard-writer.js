...
export function formatPostcardField(label, value, width) {
  if(typeof label !== "string" || label.trim() === "" || typeof value !== "string" || value.trim() === "")return ""
...
export function isFromState(address, stateCode) {
  if(typeof address !== "string" || address.trim() === "" || typeof stateCode !== "string" || address.trim() === "")return false
